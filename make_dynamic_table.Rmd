...
7. PK data characteristics:
    +  This column states whether human/patient pahramcokientics were mimicked in the experimental setup or used for simulations with a final PKPD model (replacing the PK component by
    a patient based population PK model)
...
caption = htmltools::tags$caption(
  ...
  "Human PK (human pharmacokinetics): MRSA: methicillin-resistant Staphylococcus aureus; HAP: hospital-acquired pneumonia; VAP: ventilator-associated pneumonia; ARC: augmented renal clearance;"
    )
) %>%
  formatStyle(
    1,
