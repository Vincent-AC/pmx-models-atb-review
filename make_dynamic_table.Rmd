...
growth_model_table <- select(all_data,
  ...
  mutate(growth_model_equation = case_when(growth_model=="growing and resting bacteria"~"Self-limting growth",
...
ggsave("figures/figure_drug_family.eps",
       width=20,
       height=15,
       units="cm")
...
ggsave("figures/figure_experiment_type.eps",
       width=20,
       height=15,
       units="cm")
...
ggsave("figures/figure_interaction_model.eps",
       width=20,
       height=15,
       units="cm")
...
ggsave("figures/figure_interaction_effect.eps",
       width=20,
       height=15,
       units="cm")
